...
describe('isGeneratedEmail', () => {
    it('should return true for disposable email domains', () => {
        assert.strictEqual(isGeneratedEmail('redjerky@mailinator.com'), true);
        assert.strictEqual(isGeneratedEmail('bluered@10minutemail.com'), true);
    });

    it('should return false for valid email domains', () => {
        assert.strictEqual(isGeneratedEmail('john.doe@gmail.com'), false);
        assert.strictEqual(isGeneratedEmail('staci.pringles@yahoo.com'), false);
    });
